...
public class ApiModel {
    ...
    public static class MatchingResponseModel{
        String message;
        ...
        public ArrayList<MatchingModel> getData() {
            return data;
        }

        public void setData(ArrayList<MatchingModel> data) {
            this.data = data;
        }

        int statusCode;
        ArrayList<MatchingModel> data;
    }
