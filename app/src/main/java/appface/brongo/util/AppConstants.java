...
public class AppConstants {
    ...
    public static final String NO_OF_CLIENT_RATED = "NO_OF_CLIENT_RATED";
    public static final String PLAN_TYPE = "PLAN_TYPE";
    public static final String COMMISSION = "COMMISSION";
    public static final String NOTIFICATION_BADGES = "NOTIFICATION_BADGES";
    public static final String POTENTIAL_COMMISSION = "POTENTIAL_COMMISSION";
    public static final String MICROMARKET_NAME = "MICROMARKET_NAME";
